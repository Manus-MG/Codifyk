...
class _SignUpViewState extends State<SignUpView> {
  ...
  void login(bool validity) {
    ...
    bool isValid = validity && isEmailValid && isPassValid;
    ...
    if (!isValid) {
      ...
      // Navigate karwa denge home screen pr
    }
  }
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                            "Welcome to our App, create a new account on a single click",
                        ...
                        Container(
                          ...
                          child: CupertinoButton(
                            ...
                            onPressed: () async {
                              // _isLoading = await createUserWithEmailAndPassword(
                        ...
                        Container(
                          decoration: BoxDecoration(
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xff131519).withOpacity(0.4),
                                blurRadius: 20,
                                offset: const Offset(0, 10),
                              )
                            ],
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => SignInView(
                                            closeModal: () {},
                                            // closeModal: () {_signInAnimController?.reverse();}
                                          )));
