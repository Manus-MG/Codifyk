...
import 'package:endproject1/screens/singleUserScreenModels/submissions.dart'
    as Sub;
import 'package:endproject1/screens/singleUserScreenModels/userInfo.dart' as Info;
...
class _SingleUserDetailsPageState extends State<SingleUserDetailsPage> {
  ...
  void getdata() async {
    ...
    //link generation
    print(widget.handle);
    var url1 = Uri.parse("https://codeforces.com/api/user.info?handles=${widget.handle}");
        // "codeforces.com", "/api/user.info?handles=${widget.handle}");
    var url2 = Uri.parse("https://codeforces.com/api/user.status?handle=${widget.handle}");
        // "codeforces.com", "/api/user.status?handle=${widget.handle}");
    var url3 = Uri.parse("https://codeforces.com/api/user.rating?handle=${widget.handle}");
                                // https://codeforces.com/api/user.rating?handle=maomao90
        // "codeforces.com", "/api/user.rating?handle=${widget.handle}");
    ...
    print(userRatingChangesResponse.statusCode);
    print(userInfoResponse.statusCode);
    // print(userSubmissionResponse.body);
    //.....................................................
                    ...
                    titlesData: FlTitlesData(
                      ...
                      leftTitles: AxisTitles(
                        sideTitles: SideTitles(
                          ...
                          reservedSize: 30,
                          getTitlesWidget: (value, meta) {
                            if (value.toInt() % 50 != 0) return Container();
                            return Text(
                              value.toInt().toString(),
                              style: TextStyle(color: Colors.black, fontSize: 12),
                            );
